...
function L8_1(A0_2, A1_2, A2_2, A3_2, A4_2, A5_2, A6_2, A7_2, A8_2)
  ...
  L9_2.dungeonId = A2_2
  L9_2.questId = A3_2
  L9_2.questPointCfgId = A4_2
  L9_2.actor = A6_2
  L9_2.finishLoadSceneCallback = A7_2
  L9_2.enterScenePostFinishCallback = A8_2
  L10_2 = L9_2.dialogIds
  if L10_2 ~= nil then
    L11_2 = #L10_2
    if 0 < L11_2 then
      L9_2.useDialog = true
    ...
    L9_2.useDialog = false
  end
  L11_2 = A0_2.uActor
  L12_2 = L11_2
  L11_2 = L11_2.PlayerEnterDungeonByRequest
  L13_2 = L9_2
  L11_2(L12_2, L13_2)
end
L1_1.PlayerEnterDungeonWithData = L8_1
function L8_1(A0_2, A1_2, A2_2, A3_2, A4_2, A5_2, A6_2)
  local L7_2, L8_2, L9_2, L10_2, L11_2, L12_2, L13_2
  if A6_2 == nil then
    A6_2 = false
  end
  if A3_2 ~= nil and A3_2 or A6_2 then
    if A5_2 == nil then
      A5_2 = 0
    end
    L7_2 = A0_2.uActor
    L8_2 = L7_2
    L7_2 = L7_2.PlayerEnterDungeonWithQuestLoading
    L9_2 = A1_2
    L10_2 = A2_2
    L11_2 = A4_2
    L12_2 = A5_2
...
function L8_1(A0_2, A1_2, A2_2, A3_2, A4_2, A5_2, A6_2, A7_2, A8_2, A9_2, A10_2)
  ...
  L11_2 = A0_2.uActor
  L12_2 = L11_2
  L11_2 = L11_2.PlayerEnterDungeonPointWithDialogs
  L13_2 = A1_2
  L14_2 = A2_2
  L15_2 = A3_2
  L16_2 = A4_2
