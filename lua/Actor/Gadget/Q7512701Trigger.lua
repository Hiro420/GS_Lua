...
L0_1 = L0_1(L1_1)
L1_1 = class
L2_1 = "Q7512701Trigger"
L3_1 = L0_1
L1_1 = L1_1(L2_1, L3_1)
L1_1.defaultAlias = "Q7512701Trigger"
L2_1 = require
L3_1 = "Quest/Client/Q75127ClientConfig"
L2_1 = L2_1(L3_1)
L3_1 = nil
L4_1 = L2_1.SubIDs
L5_1 = L2_1.Npcs
...
function L7_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "Q7512701Trigger - OnPostDataPrepare"
  L1_2(L2_2)
  L3_1 = A0_2
end
...
function L7_1(A0_2)
  ...
  L1_2 = print
  L2_2 = "Q7512701Trigger - OnPostComponentPrepare"
  L1_2(L2_2)
  L1_2 = L3_1
  L2_2 = L1_2
...
function L7_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "Q7512701Trigger - TriggerIn"
  L1_2(L2_2)
end
L1_1.TriggerIn = L7_1
function L7_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "Q7512701Trigger - PreTriggerIn"
  L1_2(L2_2)
end
...
function L7_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "Q7512701Trigger - LightUpTriggerIn"
  L1_2(L2_2)
end
...
function L7_1(A0_2)
  ...
  L1_2 = print
  L2_2 = "Q7512701Trigger - TriggerOut"
  L1_2(L2_2)
  L1_2 = actorUtils
