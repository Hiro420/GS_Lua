...
L3_1 = L0_1
L1_1 = L1_1(L2_1, L3_1)
L1_1.defaultAlias = "Q71537trigger"
L2_1 = require
L3_1 = "Quest/Client/Q71537ClientConfig"
L2_1 = L2_1(L3_1)
L3_1 = nil
L4_1 = L2_1.SubIDs
L5_1 = L2_1.Npcs
...
function L7_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "Q71537trigger - OnPostDataPrepare"
  L1_2(L2_2)
  L3_1 = A0_2
end
...
function L7_1(A0_2)
  ...
  L1_2 = print
  L2_2 = "Q71537trigger - OnPostComponentPrepare"
  L1_2(L2_2)
  L1_2 = L3_1
  L2_2 = L1_2
...
function L7_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "Q71537trigger - PreTriggerIn"
  L1_2(L2_2)
end
...
function L7_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "Q71537trigger - LightUpTriggerIn"
  L1_2(L2_2)
end
