...
L0_1 = L0_1(L1_1)
L1_1 = class
L2_1 = "Q1404604Trigger"
L3_1 = L0_1
L1_1 = L1_1(L2_1, L3_1)
L1_1.defaultAlias = "Q1404604Trigger"
L2_1 = require
L3_1 = "Quest/Client/Q14046ClientConfig"
L2_1 = L2_1(L3_1)
L3_1 = nil
L4_1 = L2_1.SubIDs
L5_1 = L2_1.Datas
...
function L8_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "Q1404604Trigger - OnPostDataPrepare"
  L1_2(L2_2)
  L3_1 = A0_2
end
...
function L8_1(A0_2)
  ...
  L1_2 = print
  L2_2 = "Q1404604Trigger - OnPostComponentPrepare"
  L1_2(L2_2)
  L1_2 = L3_1
  L2_2 = L1_2
...
function L8_1(A0_2)
  ...
  L1_2 = print
  L2_2 = "Q1404604Trigger - TriggerIn"
  L1_2(L2_2)
  L1_2 = actorUtils
  ...
  function L4_2(A0_3)
    ...
    function L6_3(A0_4)
      ...
      L4_4 = L5_1.NarratorWithId_1404602
      L5_4 = nil
      L2_4(L3_4, L4_4, L5_4)
      L2_4 = L3_1
      L3_4 = L2_4
...
function L8_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "Q1404604Trigger - PreTriggerIn"
  L1_2(L2_2)
end
...
function L8_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "Q1404604Trigger - LightUpTriggerIn"
  L1_2(L2_2)
end
...
function L8_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "Q1404604Trigger - TriggerOut"
  L1_2(L2_2)
end
