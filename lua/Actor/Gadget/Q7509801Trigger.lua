...
L0_1 = L0_1(L1_1)
L1_1 = class
L2_1 = "Q7509801Trigger"
L3_1 = L0_1
L1_1 = L1_1(L2_1, L3_1)
L1_1.defaultAlias = "Q7509801Trigger"
L2_1 = require
L3_1 = "Quest/Client/Q75098ClientConfig"
L2_1 = L2_1(L3_1)
L3_1 = nil
L4_1 = L2_1.SubIDs
L5_1 = L2_1.Npcs
...
function L7_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "Q7509801Trigger - OnPostDataPrepare"
  L1_2(L2_2)
  L3_1 = A0_2
end
...
function L7_1(A0_2)
  ...
  L1_2 = print
  L2_2 = "Q7509801Trigger - OnPostComponentPrepare"
  L1_2(L2_2)
  L1_2 = L3_1
  L2_2 = L1_2
...
function L7_1(A0_2)
  ...
  L1_2 = print
  L2_2 = "Q7509801Trigger - TriggerIn"
  L1_2(L2_2)
  L1_2 = L3_1
  L2_2 = L1_2
...
function L7_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "Q7509801Trigger - PreTriggerIn"
  L1_2(L2_2)
end
...
function L7_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "Q7509801Trigger - LightUpTriggerIn"
  L1_2(L2_2)
end
...
function L7_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "Q7509801Trigger - TriggerOut"
  L1_2(L2_2)
end
