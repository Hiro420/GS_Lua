...
L3_1 = L0_1
L1_1 = L1_1(L2_1, L3_1)
L1_1.defaultAlias = "Q14008Trigger1"
L2_1 = require
...
function L8_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "[MainId: 14008][Trigger: Q14008Trigger1] OnPostDataPrepare"
  L1_2(L2_2)
  L3_1 = A0_2
end
...
function L8_1(A0_2)
  ...
  L1_2 = print
  L2_2 = "[MainId: 14008][Trigger: Q14008Trigger1] OnPostComponentPrepare"
  L1_2(L2_2)
  L1_2 = L3_1
  L2_2 = L1_2
...
function L8_1(A0_2)
  local L1_2, L2_2, L3_2, L4_2, L5_2, L6_2, L7_2, L8_2, L9_2, L10_2, L11_2, L12_2
  L1_2 = print
  L2_2 = "[MainId: 14008][Trigger: Q14008Trigger1] TriggerIn"
  L1_2(L2_2)
  L1_2 = actorMgr
  L2_2 = L1_2
  L1_2 = L1_2.GetActor
...
function L8_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "[MainId: 14008][Trigger: Q14008Trigger1] PreTriggerIn"
  L1_2(L2_2)
end
...
function L8_1(A0_2)
  local L1_2, L2_2, L3_2, L4_2, L5_2, L6_2, L7_2, L8_2, L9_2, L10_2, L11_2, L12_2
  L1_2 = print
  L2_2 = "[MainId: 14008][Trigger: Q14008Trigger1] LightUpTriggerIn"
  L1_2(L2_2)
  L1_2 = actorMgr
  L2_2 = L1_2
  L1_2 = L1_2.GetActor
...
function L8_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "[MainId: 14008][Trigger: Q14008Trigger1] TriggerOut"
  L1_2(L2_2)
end
