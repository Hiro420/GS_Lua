...
L0_1 = L0_1(L1_1)
L1_1 = class
L2_1 = "Q7421901Trigger"
L3_1 = L0_1
L1_1 = L1_1(L2_1, L3_1)
L1_1.defaultAlias = "Q7421901Trigger"
L2_1 = require
...
function L5_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "[MainId: 74219][Trigger: Q7421901Trigger] OnPostDataPrepare"
  L1_2(L2_2)
  L3_1 = A0_2
end
...
function L5_1(A0_2)
  ...
  L1_2 = print
  L2_2 = "[MainId: 74219][Trigger: Q7421901Trigger] OnPostComponentPrepare"
  L1_2(L2_2)
  L1_2 = L3_1
  L2_2 = L1_2
...
function L5_1(A0_2)
  ...
  L1_2 = print
  L2_2 = "[MainId: 74219][Trigger: Q7421901Trigger] TriggerIn"
  L1_2(L2_2)
  L1_2 = actorMgr
  L2_2 = L1_2
  L1_2 = L1_2.GetActor
...
function L5_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "[MainId: 74219][Trigger: Q7421901Trigger] PreTriggerIn"
  L1_2(L2_2)
end
...
function L5_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "[MainId: 74219][Trigger: Q7421901Trigger] LightUpTriggerIn"
  L1_2(L2_2)
end
...
function L5_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "[MainId: 74219][Trigger: Q7421901Trigger] TriggerOut"
  L1_2(L2_2)
end
