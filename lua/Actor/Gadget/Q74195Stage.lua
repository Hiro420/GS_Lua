...
function L6_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "[MainId: 74195][Trigger: Q74195Stage] OnPostDataPrepare"
  L1_2(L2_2)
  L3_1 = A0_2
end
...
function L6_1(A0_2)
  ...
  L1_2 = print
  L2_2 = "[MainId: 74195][Trigger: Q74195Stage] OnPostComponentPrepare"
  L1_2(L2_2)
  L1_2 = L3_1
  L2_2 = L1_2
...
function L6_1(A0_2)
  ...
  L1_2 = print
  L2_2 = "[MainId: 74195][Trigger: Q74195Stage] TriggerIn"
  L1_2(L2_2)
  L1_2 = actorUtils
...
function L6_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "[MainId: 74195][Trigger: Q74195Stage] PreTriggerIn"
  L1_2(L2_2)
end
...
function L6_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "[MainId: 74195][Trigger: Q74195Stage] LightUpTriggerIn"
  L1_2(L2_2)
end
...
function L6_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "[MainId: 74195][Trigger: Q74195Stage] TriggerOut"
  L1_2(L2_2)
end
