...
L0_1 = L0_1(L1_1)
L1_1 = class
L2_1 = "Trigger_7501804"
L3_1 = L0_1
L1_1 = L1_1(L2_1, L3_1)
L1_1.defaultAlias = "Trigger_7501804"
L2_1 = require
L3_1 = "Quest/Client/Q75018ClientConfig"
L2_1 = L2_1(L3_1)
L3_1 = nil
L4_1 = L2_1.SubIDs
L5_1 = L2_1.Npcs
...
function L7_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "Trigger_7501804 - OnPostDataPrepare"
  L1_2(L2_2)
  L3_1 = A0_2
end
...
function L7_1(A0_2)
  ...
  L1_2 = print
  L2_2 = "Trigger_7501804 - OnPostComponentPrepare"
  L1_2(L2_2)
  L1_2 = L3_1
  L2_2 = L1_2
...
function L7_1(A0_2)
  ...
  L1_2 = print
  L2_2 = "Trigger_7501804 - TriggerIn"
  L1_2(L2_2)
  L1_2 = actorUtils
...
function L7_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "Trigger_7501804 - PreTriggerIn"
  L1_2(L2_2)
end
...
function L7_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "Trigger_7501804 - LightUpTriggerIn"
  L1_2(L2_2)
end
...
function L7_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "Trigger_7501804 - TriggerOut"
  L1_2(L2_2)
end
