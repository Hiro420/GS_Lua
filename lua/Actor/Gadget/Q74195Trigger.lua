...
L3_1 = L0_1
L1_1 = L1_1(L2_1, L3_1)
L1_1.defaultAlias = "Q74195Trigger"
L2_1 = require
...
function L6_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "[MainId: 74195][Trigger: Q74195Trigger] OnPostDataPrepare"
  L1_2(L2_2)
  L3_1 = A0_2
end
...
function L6_1(A0_2)
  ...
  L1_2 = print
  L2_2 = "[MainId: 74195][Trigger: Q74195Trigger] OnPostComponentPrepare"
  L1_2(L2_2)
  L1_2 = L3_1
  L2_2 = L1_2
...
function L6_1(A0_2)
  ...
  L1_2 = print
  L2_2 = "[MainId: 74195][Trigger: Q74195Trigger] TriggerIn"
  L1_2(L2_2)
  L1_2 = actorUtils
...
function L6_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "[MainId: 74195][Trigger: Q74195Trigger] PreTriggerIn"
  L1_2(L2_2)
end
...
function L6_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "[MainId: 74195][Trigger: Q74195Trigger] LightUpTriggerIn"
  L1_2(L2_2)
end
...
function L6_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "[MainId: 74195][Trigger: Q74195Trigger] TriggerOut"
  L1_2(L2_2)
end
