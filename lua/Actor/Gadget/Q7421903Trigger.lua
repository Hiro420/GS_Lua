...
L0_1 = L0_1(L1_1)
L1_1 = class
L2_1 = "Q7421903Trigger"
L3_1 = L0_1
L1_1 = L1_1(L2_1, L3_1)
L1_1.defaultAlias = "Q7421903Trigger"
L2_1 = require
...
function L5_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "[MainId: 74219][Trigger: Q7421903Trigger] OnPostDataPrepare"
  L1_2(L2_2)
  L3_1 = A0_2
end
...
function L5_1(A0_2)
  ...
  L1_2 = print
  L2_2 = "[MainId: 74219][Trigger: Q7421903Trigger] OnPostComponentPrepare"
  L1_2(L2_2)
  L1_2 = L3_1
  L2_2 = L1_2
...
function L5_1(A0_2)
  ...
  L1_2 = print
  L2_2 = "[MainId: 74219][Trigger: Q7421903Trigger] TriggerIn"
  L1_2(L2_2)
  L1_2 = actorMgr
  L2_2 = L1_2
  L1_2 = L1_2.GetActor
...
function L5_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "[MainId: 74219][Trigger: Q7421903Trigger] PreTriggerIn"
  L1_2(L2_2)
end
...
function L5_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "[MainId: 74219][Trigger: Q7421903Trigger] LightUpTriggerIn"
  L1_2(L2_2)
end
...
function L5_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "[MainId: 74219][Trigger: Q7421903Trigger] TriggerOut"
  L1_2(L2_2)
end
