...
L0_1 = L0_1(L1_1)
L1_1 = class
L2_1 = "Q7419528Trigger"
L3_1 = L0_1
L1_1 = L1_1(L2_1, L3_1)
L1_1.defaultAlias = "Q7419528Trigger"
L2_1 = require
...
function L6_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "[MainId: 74195][Trigger: Q7419528Trigger] OnPostDataPrepare"
  L1_2(L2_2)
  L3_1 = A0_2
end
...
function L6_1(A0_2)
  ...
  L1_2 = print
  L2_2 = "[MainId: 74195][Trigger: Q7419528Trigger] OnPostComponentPrepare"
  L1_2(L2_2)
  L1_2 = L3_1
  L2_2 = L1_2
...
function L6_1(A0_2)
  local L1_2, L2_2, L3_2, L4_2, L5_2, L6_2, L7_2, L8_2, L9_2, L10_2, L11_2
  L1_2 = print
  L2_2 = "[MainId: 74195][Trigger: Q7419528Trigger] TriggerIn"
  L1_2(L2_2)
  L1_2 = actorMgr
  L2_2 = L1_2
  L1_2 = L1_2.GetActor
...
function L6_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "[MainId: 74195][Trigger: Q7419528Trigger] PreTriggerIn"
  L1_2(L2_2)
end
...
function L6_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "[MainId: 74195][Trigger: Q7419528Trigger] LightUpTriggerIn"
  L1_2(L2_2)
end
...
function L6_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "[MainId: 74195][Trigger: Q7419528Trigger] TriggerOut"
  L1_2(L2_2)
end
