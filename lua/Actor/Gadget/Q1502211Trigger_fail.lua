...
L0_1 = L0_1(L1_1)
L1_1 = class
L2_1 = "Q1502211Trigger_fail"
L3_1 = L0_1
L1_1 = L1_1(L2_1, L3_1)
L1_1.defaultAlias = "Q1502211Trigger_fail"
L2_1 = require
...
function L8_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "Q1502211Trigger_fail - OnPostDataPrepare"
  L1_2(L2_2)
  L3_1 = A0_2
end
...
function L8_1(A0_2)
  ...
  L1_2 = print
  L2_2 = "Q1502211Trigger_fail - OnPostComponentPrepare"
  L1_2(L2_2)
  L1_2 = L3_1
  L2_2 = L1_2
...
function L8_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "Q1502211Trigger_fail - TriggerIn"
  L1_2(L2_2)
end
L1_1.TriggerIn = L8_1
function L8_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "Q1502211Trigger_fail - PreTriggerIn"
  L1_2(L2_2)
end
...
function L8_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "Q1502211Trigger_fail - LightUpTriggerIn"
  L1_2(L2_2)
end
...
function L8_1(A0_2)
  ...
  L1_2 = print
  L2_2 = "Q1502211Trigger_fail - TriggerOut"
  L1_2(L2_2)
  L1_2 = actorUtils
