...
L0_1 = L0_1(L1_1)
L1_1 = class
L2_1 = "Q802203Trigger1"
L3_1 = L0_1
L1_1 = L1_1(L2_1, L3_1)
L1_1.defaultAlias = "Q802203Trigger1"
L2_1 = require
L3_1 = "Quest/Client/Q8022ClientConfig"
L2_1 = L2_1(L3_1)
L3_1 = nil
L4_1 = L2_1.SubIDs
L5_1 = L2_1.Points
function L6_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "Q802203Trigger1 - OnPostDataPrepare"
  L1_2(L2_2)
  L3_1 = A0_2
end
...
function L6_1(A0_2)
  ...
  L1_2 = print
  L2_2 = "Q802203Trigger1 - OnPostComponentPrepare"
  L1_2(L2_2)
  L1_2 = L3_1
  L2_2 = L1_2
...
function L6_1(A0_2)
  ...
  L1_2 = print
  L2_2 = "Q802203Trigger1 - TriggerIn"
  L1_2(L2_2)
  L1_2 = actorUtils
...
function L6_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "Q802203Trigger1 - PreTriggerIn"
  L1_2(L2_2)
end
...
function L6_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "Q802203Trigger1 - LightUpTriggerIn"
  L1_2(L2_2)
end
...
function L6_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "Q802203Trigger1 - TriggerOut"
  L1_2(L2_2)
end
