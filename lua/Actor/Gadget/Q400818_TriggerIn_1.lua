...
L0_1 = L0_1(L1_1)
L1_1 = class
L2_1 = "Q400818_TriggerIn_1"
L3_1 = L0_1
L1_1 = L1_1(L2_1, L3_1)
L1_1.defaultAlias = "Q400818_TriggerIn_1"
L2_1 = require
...
function L8_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "[MainId: 4008][Trigger: Q400818_TriggerIn_1] OnPostDataPrepare"
  L1_2(L2_2)
  L3_1 = A0_2
end
...
function L8_1(A0_2)
  ...
  L1_2 = print
  L2_2 = "[MainId: 4008][Trigger: Q400818_TriggerIn_1] OnPostComponentPrepare"
  L1_2(L2_2)
  L1_2 = L3_1
  L2_2 = L1_2
...
function L8_1(A0_2)
  ...
  L1_2 = print
  L2_2 = "[MainId: 4008][Trigger: Q400818_TriggerIn_1] TriggerIn"
  L1_2(L2_2)
  L1_2 = actorMgr
  L2_2 = L1_2
  L1_2 = L1_2.GetActor
  ...
  L4_2 = L7_1.NarratorWithId_400810
  L2_2(L3_2, L4_2)
  L3_2 = L1_2
...
function L8_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "[MainId: 4008][Trigger: Q400818_TriggerIn_1] PreTriggerIn"
  L1_2(L2_2)
end
...
function L8_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "[MainId: 4008][Trigger: Q400818_TriggerIn_1] LightUpTriggerIn"
  L1_2(L2_2)
end
...
function L8_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "[MainId: 4008][Trigger: Q400818_TriggerIn_1] TriggerOut"
  L1_2(L2_2)
end
