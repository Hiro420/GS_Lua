...
L0_1 = L0_1(L1_1)
L1_1 = class
L2_1 = "SetWeatherTrigger"
L3_1 = L0_1
L1_1 = L1_1(L2_1, L3_1)
L1_1.defaultAlias = "SetWeatherTrigger"
function L2_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
...
function L2_1(A0_2)
  ...
  L1_2(L2_2)
  L1_2 = actorMgr
  L1_2 = L1_2.WeatherGadgetTriggerDic
  L2_2 = A0_2.alias
  L1_2 = L1_2[L2_2]
  if L1_2 == nil then
    L2_2 = print
...
function L2_1(A0_2)
  ...
  L2_2 = print
  L3_2 = "SetWeatherTrigger TriggerIn alias:"
  L4_2 = A0_2.alias
  L5_2 = " weather ="
  L6_2 = L1_2.weatherName
  ...
  if L2_2 ~= nil then
    L4_2 = L2_2
    L3_2 = L2_2.SetWeather
    L5_2 = L1_2.weatherName
    L3_2(L4_2, L5_2)
  end
end
L1_1.TriggerIn = L2_1
function L2_1(A0_2)
  ...
  L2_2 = print
  L3_2 = "SetWeatherTrigger TriggerOut"
  L2_2(L3_2)
  L2_2 = actorMgr
  L3_2 = L2_2
  L2_2 = L2_2.GetActorInternal
