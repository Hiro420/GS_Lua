...
L3_1 = L0_1
L1_1 = L1_1(L2_1, L3_1)
L1_1.defaultAlias = "Q4022Trigger3"
L2_1 = require
...
function L9_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "[MainId: 4022][Trigger: Q4022Trigger3] OnPostDataPrepare"
  L1_2(L2_2)
  L3_1 = A0_2
end
...
function L9_1(A0_2)
  ...
  L1_2 = print
  L2_2 = "[MainId: 4022][Trigger: Q4022Trigger3] OnPostComponentPrepare"
  L1_2(L2_2)
  L1_2 = L3_1
  L2_2 = L1_2
...
function L9_1(A0_2)
  ...
  L1_2 = print
  L2_2 = "[MainId: 4022][Trigger: Q4022Trigger3] TriggerIn"
  L1_2(L2_2)
  L1_2 = actorMgr
  L2_2 = L1_2
  L1_2 = L1_2.GetActor
...
function L9_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "[MainId: 4022][Trigger: Q4022Trigger3] PreTriggerIn"
  L1_2(L2_2)
end
...
function L9_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "[MainId: 4022][Trigger: Q4022Trigger3] LightUpTriggerIn"
  L1_2(L2_2)
end
...
function L9_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "[MainId: 4022][Trigger: Q4022Trigger3] TriggerOut"
  L1_2(L2_2)
end
