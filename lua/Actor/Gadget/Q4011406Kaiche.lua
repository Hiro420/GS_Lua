...
L3_1 = L0_1
L1_1 = L1_1(L2_1, L3_1)
L1_1.defaultAlias = "Q4011406Kaiche"
L2_1 = require
...
function L8_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "[MainId: 40114][Trigger: Q4011406Kaiche] OnPostDataPrepare"
  L1_2(L2_2)
  L3_1 = A0_2
end
...
function L8_1(A0_2)
  ...
  L1_2 = print
  L2_2 = "[MainId: 40114][Trigger: Q4011406Kaiche] OnPostComponentPrepare"
  L1_2(L2_2)
  L1_2 = L3_1
  L2_2 = L1_2
...
function L8_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "[MainId: 40114][Trigger: Q4011406Kaiche] PreTriggerIn"
  L1_2(L2_2)
end
...
function L8_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "[MainId: 40114][Trigger: Q4011406Kaiche] LightUpTriggerIn"
  L1_2(L2_2)
end
...
function L8_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "[MainId: 40114][Trigger: Q4011406Kaiche] TriggerOut"
  L1_2(L2_2)
end
