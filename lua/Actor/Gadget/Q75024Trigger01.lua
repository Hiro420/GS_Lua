...
L0_1 = L0_1(L1_1)
L1_1 = class
L2_1 = "Q75024Trigger01"
L3_1 = L0_1
L1_1 = L1_1(L2_1, L3_1)
L1_1.defaultAlias = "Q75024Trigger01"
L2_1 = require
...
function L8_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "Q75024Trigger01 - OnPostDataPrepare"
  L1_2(L2_2)
  L3_1 = A0_2
end
...
function L8_1(A0_2)
  ...
  L1_2 = print
  L2_2 = "Q75024Trigger01 - OnPostComponentPrepare"
  L1_2(L2_2)
  L1_2 = L3_1
  L2_2 = L1_2
...
function L8_1(A0_2)
  ...
  L1_2 = print
  L2_2 = "Q75024Trigger01 - TriggerIn"
  L1_2(L2_2)
  L1_2 = actorMgr
  L2_2 = L1_2
  L1_2 = L1_2.GetActor
...
function L8_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "Q75024Trigger01 - PreTriggerIn"
  L1_2(L2_2)
end
...
function L8_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "Q75024Trigger01 - LightUpTriggerIn"
  L1_2(L2_2)
end
...
function L8_1(A0_2)
  local L1_2, L2_2
  L1_2 = print
  L2_2 = "Q75024Trigger01 - TriggerOut"
  L1_2(L2_2)
end
