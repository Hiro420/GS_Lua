...
function L2_1(A0_2)
  ...
  L3_2 = util
  L3_2 = L3_2.begin_sample
  L4_2 = "[NpcFSMBehaviour]LoungeScheduleData"
  L3_2(L4_2)
  L4_2 = A0_2
  L3_2 = A0_2.TryCreateLoungeTask
  L5_2 = A0_2.ConfigData
  L5_2 = L5_2.LoungeScheduleData
  L3_2(L4_2, L5_2)
  L3_2 = util
  L3_2 = L3_2.end_sample
  L3_2()
...
function L2_1(A0_2, A1_2)
  ...
  L2_2 = A0_2.loungeTask
  if L2_2 == nil then
    L3_2 = A0_2
    L2_2 = A0_2.CreateTask
    L4_2 = TaskID
    L4_2 = L4_2.LOUNGE_TASK_ID
    L5_2 = LuaTaskType
    L5_2 = L5_2.LOUNGE
    L6_2 = "Lounge"
    L2_2 = L2_2(L3_2, L4_2, L5_2, L6_2)
    A0_2.loungeTask = L2_2
    L2_2 = A0_2.loungeTask
    L3_2 = L2_2
    L2_2 = L2_2.InitParam
    L4_2 = A1_2.actionList
...
function L2_1(A0_2)
  ...
  if L1_2 ~= nil then
    L1_2 = A0_2.uActor
    L2_2 = L1_2
    L1_2 = L1_2.IsDailySpeechBubbleDisabled
    L1_2 = L1_2(L2_2)
    if L1_2 ~= false then
      goto lbl_11
    end
