...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q12005TriggerBattleOut.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q12005TriggerBattleOut", l_0_0)
l_0_1.defaultAlias = "Q12005TriggerBattleOut"
local l_0_2 = (upval_0.require)("Quest/Client/Q12005ClientConfig")
...
l_0_1.TriggerOut = function(l_4_0)
  ...
  if l_4_1:GetSubQuestState(1200510) == 2 then
    l_4_1:FinishQuestID(true, 1200510)
  end
  l_4_0:DestroySelf()
  ;
  (upval_0.print)("Rewindquest and take trialavatar back")
end
