...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q304Feather.luac 
...
local l_0_2 = (upval_0.require)("Actor/Quest/Q304/Q304Config")
local l_0_3 = l_0_2.FeatherData
...
l_0_4 = function(l_3_0, l_3_1)
  ...
  if l_3_1 == 2 then
    (upval_0.globalActor):SpawnGadget(upval_1.FeatherGadgetID, upval_1.feather1Pos, upval_1.feather1Dir, "Feather1")
  end
end

l_0_1.OnInterStart = l_0_4
return l_0_1
