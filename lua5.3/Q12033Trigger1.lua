...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q12033Trigger1.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q12033Trigger1", l_0_0)
l_0_1.defaultAlias = "Q12033Trigger1"
local l_0_2 = (upval_0.require)("Quest/Client/Q12033ClientConfig")
...
l_0_1.TriggerIn = function(l_3_0)
  ...
  local l_3_1 = (upval_0.actorMgr):GetActor("12033")
  ...
  local l_3_7 = function(l_4_0)
    ...
    local l_4_1 = (upval_0.actorMgr):GetActor("12033")
    l_4_1:CreateQuestNpcById(1203303, (upval_1.Npc12077Data).id, 0)
    l_4_1:CreateQuestNpcById(1203303, (upval_1.Npc12485Data).id, 0)
    l_4_1:RequestInteraction((upval_1.Npc12077Data).alias)
  end
