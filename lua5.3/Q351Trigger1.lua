...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q351Trigger1.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q351Trigger1", l_0_0)
l_0_1.defaultAlias = "Q351Trigger1"
local l_0_2 = (upval_0.require)("Quest/Client/Q351ClientConfig")
...
l_0_1.TriggerOut = function(l_4_0)
  ...
  ;
  (upval_0.print)("Out Q351Trigger1")
  local l_4_1 = (upval_0.actorMgr):GetActor(upval_1.ActorAlias)
  if l_4_1 ~= nil then
    l_4_1:FinishQuestID(false, 35100)
  end
  l_4_0:DestroySelf()
end
