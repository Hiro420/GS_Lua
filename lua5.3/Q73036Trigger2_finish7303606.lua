...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q73036Trigger2_finish7303606.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q73036Trigger2_finish7303606", l_0_0)
l_0_1.defaultAlias = "Q73036Trigger2_finish7303606"
...
l_0_1.TriggerIn = function(l_3_0)
  ...
  ;
  ((upval_0.actorUtils).FinishQuestID)(false, 7303606)
  l_3_0:DestroySelf()
end
