...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q1202605TriggerItto.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q1202605TriggerItto", l_0_0)
l_0_1.defaultAlias = "Q1202605TriggerItto"
...
l_0_1.TriggerIn = function(l_3_0)
  ...
  l_3_1:CallDelay(1.5, function(l_4_0)
    ...
    local l_4_1 = (upval_0.actorMgr):GetActor("12026")
    ...
    local l_4_7 = function(l_5_0)
      ...
      local l_5_1 = (upval_0.actorMgr):GetActor("12026")
      l_5_1:CreateQuestNpcById(1202605, (upval_1.Npc1044Data).id, 2)
      l_5_1:RequestInteraction((upval_1.Npc1044Data).alias)
    end
