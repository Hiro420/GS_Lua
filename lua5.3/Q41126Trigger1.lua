...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q41126Trigger1.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q41126Trigger1", l_0_0)
l_0_1.defaultAlias = "Q41126Trigger1"
local l_0_2 = (upval_0.require)("Quest/Client/Q41126ClientConfig")
...
l_0_1.TriggerIn = function(l_3_0)
  ...
  (upval_0.print)("TriggerIn1")
  local l_3_1 = (upval_0.actorMgr):GetActor(upval_1)
  l_3_1:FinishQuestID(false, 4112612)
  l_3_0:DestroySelf()
end
