...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q1104201Trigger.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q1104201Trigger", l_0_0)
l_0_1.defaultAlias = "Q1104201Trigger"
local l_0_2 = (upval_0.require)("Quest/Client/Q11042ClientConfig")
...
l_0_1.TriggerIn = function(l_3_0)
  ...
  l_3_0:ShowBlackScreen(0.5, 1, 0.5, function(l_4_0)
    ...
    l_4_1:CreateQuestNpcById(1104201, (upval_2.Npc1018Data).id, 0)
