...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q73036Trigger13_09hint1.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q73036Trigger13_09hint1", l_0_0)
l_0_1.defaultAlias = "Q73036Trigger13_09hint1"
...
l_0_1.TriggerIn = function(l_3_0)
  ...
  l_3_2(l_3_3, l_3_4, function(l_6_0)
    ...
    l_6_1:NarratorOnlyTask(upval_1.NarratorTable_Arama16, function(l_7_0)
      -- function num : 0_2_2_0 , upvalues : upval_0
      local l_7_1 = (upval_0.actorMgr):GetActor("73036")
      l_7_1:CallDelay(3, function(l_8_0)
        -- function num : 0_2_2_0_0 , upvalues : upval_0
        ((upval_0.actorUtils).FinishQuestID)(false, 7303609)
      end
)
    end
, "")
