...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q19019Trigger5.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q19019Trigger5", l_0_0)
l_0_1.defaultAlias = "Q19019Trigger5"
local l_0_2 = (upval_0.require)("Quest/Client/Q19019ClientConfig")
...
l_0_1.TriggerIn = function(l_3_0)
  ...
  local l_3_1 = (upval_0.actorMgr):GetActor("19019")
  ...
  local l_3_7 = function(l_4_0)
    ...
    local l_4_1 = (upval_0.actorMgr):GetActor("19019")
    l_4_1:CreateQuestNpcById(1901913, (upval_1.Coop_GorouData).id, 0)
