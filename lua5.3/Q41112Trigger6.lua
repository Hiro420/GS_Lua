...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q41112Trigger6.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q41112Trigger6", l_0_0)
l_0_1.defaultAlias = "Q41112Trigger6"
...
l_0_1.TriggerIn = function(l_3_0)
  ...
  if l_3_1 ~= nil then
    l_3_1:FinishQuestID(false, 4111214)
  end
  l_3_0:DestroySelf()
end
