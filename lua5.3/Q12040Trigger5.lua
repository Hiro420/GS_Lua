...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q12040Trigger5.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q12040Trigger5", l_0_0)
l_0_1.defaultAlias = "Q12040Trigger5"
...
l_0_1.OnPostComponentPrepare = function(l_3_0)
  ...
  (upval_0.print)("Q12040Trigger5 OnPostComponentPrepare")
...
l_0_1.TriggerIn = function(l_4_0)
  ...
  (upval_0.print)("Q12040Trigger5 TriggerIn")
  local l_4_1 = (upval_0.actorMgr):GetActor("12040")
  l_4_1:FinishQuestID(false, 1204014)
  l_4_0:DestroySelf()
end

l_0_1.OnDestroy = function(l_5_0)
  -- function num : 0_4 , upvalues : upval_0
  (upval_0.print)("Q12040Trigger5 OnDestroy")
end
