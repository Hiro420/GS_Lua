...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q200701Trigger.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q200701Trigger", l_0_0)
l_0_1.defaultAlias = "Q200701Trigger"
local l_0_2 = (upval_0.require)("Quest/Client/Q2007ClientConfig")
...
l_0_1.TriggerIn = function(l_3_0)
  ...
  local l_3_6 = function(l_4_0)
    ...
    l_4_1:CreateQuestNpcById(200701, (upval_2.PaimonData).id, 0)
    l_4_1:RequestInteraction((upval_2.PaimonData).alias)
    l_4_0:DestroySelf()
  end

  l_3_1(l_3_2, l_3_3, l_3_4, l_3_5, l_3_6, nil, upval_0.task, "QUEST_Black_Q1200010")
end
