...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q11030Trigger.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q11030Trigger", l_0_0)
l_0_1.defaultAlias = "Q11030Trigger"
local l_0_2 = (upval_0.require)("Quest/Client/Q11030ClientConfig")
...
l_0_1.TriggerOut = function(l_4_0)
  ...
  if l_4_1:GetSubQuestState(1103008) == 2 then
    l_4_1:FinishQuestID(true, 1103008)
  end
  ;
  (upval_0.print)("let 1103008 fail")
  l_4_0:DestroySelf()
end
