...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q2010Trigger7.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q2010Trigger7", l_0_0)
l_0_1.defaultAlias = "Q2010Trigger7"
local l_0_2 = (upval_0.require)("Quest/Client/Q2010ClientConfig")
...
l_0_1.TriggerIn = function(l_3_0)
  ...
  local l_3_1 = (upval_0.actorMgr):GetActor("2010")
  ...
  local l_3_7 = function(l_4_0)
    ...
    local l_4_1 = (upval_0.actorMgr):GetActor("2010")
    l_4_1:CreateQuestNpcById(201014, (upval_1.Npc12098Data).id, 0)
    l_4_1:RequestInteraction((upval_1.Npc12098Data).alias)
  end
