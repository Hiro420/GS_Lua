...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q11012TriggerDungeon.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q11012TriggerDungeon", l_0_0)
l_0_1.defaultAlias = "Q11012TriggerDungeon"
local l_0_2 = (upval_0.require)("Quest/Client/Q11012ClientConfig")
...
l_0_1.TriggerIn = function(l_3_0)
  ...
  if l_3_1:GetSubQuestState(1101217) == 2 then
    l_3_1:FinishQuestID(false, 1101217)
  end
  ;
  (upval_0.print)("let 1101217 finish")
  l_3_0:DestroySelf()
end
