...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q7226508TriggerAfterBattle.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q7226508TriggerAfterBattle", l_0_0)
l_0_1.defaultAlias = "Q7226508TriggerAfterBattle"
local l_0_2 = (upval_0.require)("Quest/Client/Q72265ClientConfig")
...
l_0_1.TriggerIn = function(l_3_0)
  ...
  local l_3_1 = (upval_0.actorMgr):GetActor("72265")
  ...
  local l_3_7 = function(l_4_0)
    ...
    local l_4_4 = nil
    local l_4_1 = (upval_0.actorMgr):GetActor("72265")
    local l_4_2, l_4_3 = l_4_1:TransmitPlayerById, l_4_1
    l_4_2(l_4_3, nil, 3)
  end

  l_3_2(l_3_3, l_3_4, l_3_5, l_3_6, l_3_7, nil, nil, "", false, true)
  l_3_2, l_3_3 = l_3_1:RequestInteraction, l_3_1
  l_3_4 = upval_1.Npc20485Data
  l_3_4 = l_3_4.alias
  l_3_2(l_3_3, l_3_4)
