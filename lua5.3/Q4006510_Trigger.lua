...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q4006510_Trigger.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q4006510_Trigger", l_0_0)
l_0_1.defaultAlias = "Q4006510_Trigger"
...
l_0_1.OnPostComponentPrepare = function(l_2_0)
  ...
  local l_2_3 = 5.54221
  local l_2_4 = 10.01772
  local l_2_5 = 9.033957
  local l_2_6 = false
  local l_2_7 = {}
  l_2_7.x = 0
  l_2_7.y = 0
...
l_0_1.TriggerIn = function(l_3_0)
  ...
  ;
  ((upval_0.actorUtils).FinishQuestID)(false, 4006510)
  l_3_0:DestroySelf()
end
