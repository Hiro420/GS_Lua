...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q7268404Trigger.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q7268404Trigger", l_0_0)
l_0_1.defaultAlias = "Q7268404Trigger"
...
l_0_1.TriggerIn = function(l_3_0)
  ...
  l_3_1:NarratorOnlyTaskByData(upval_1.NarratorWithId7268403, function(l_4_0)
    -- function num : 0_2_0 , upvalues : upval_0
    ((upval_0.actorUtils).FinishQuestID)(false, 7268404)
  end
, 72684)
  l_3_0:DestroySelf()
end
