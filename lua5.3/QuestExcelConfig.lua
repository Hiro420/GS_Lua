...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\QuestExcelConfig.luac 
...
upval_0.QuestGuideType, l_0_0 = l_0_0, {QUEST_GUIDE_NONE = 0, QUEST_GUIDE_LOCATION = 1, QUEST_GUIDE_NPC = 2}
upval_0.ShowQuestGuideType, l_0_0 = l_0_0, {QUEST_GUIDE_ITEM_ENABLE = 0, QUEST_GUIDE_ITEM_DISABLE = 1, QUEST_GUIDE_ITEM_MOVE_HIDE = 2}
upval_0.QuestGuideAuto, l_0_0 = l_0_0, {QUEST_GUIDE_AUTO_NONE = 0, QUEST_GUIDE_AUTO_ENABLE = 1, QUEST_GUIDE_AUTO_DISABLE = 2}
upval_0.QuestGuideStyle, l_0_0 = l_0_0, {QUEST_GUIDE_STYLE_NONE = 0, QUEST_GUIDE_STYLE_START = 1, QUEST_GUIDE_STYLE_TARGET = 2, QUEST_GUIDE_STYLE_FINISH = 3, QUEST_GUIDE_STYLE_POINT = 4}
upval_0.QuestGuideLayer, l_0_0 = l_0_0, {QUEST_GUIDE_LAYER_NONE = 0, QUEST_GUIDE_LAYER_UI = 1, QUEST_GUIDE_LAYER_SCENE = 2}
upval_0.QuestExecType, l_0_0 = l_0_0, {QUEST_EXEC_NONE = 0, QUEST_EXEC_DEL_PACK_ITEM = 1, QUEST_EXEC_UNLOCK_POINT = 2, QUEST_EXEC_UNLOCK_AREA = 3, QUEST_EXEC_UNLOCK_FORCE = 4, QUEST_EXEC_LOCK_FORCE = 5, QUEST_EXEC_CHANGE_AVATAR_ELEMET = 6, QUEST_EXEC_REFRESH_GROUP_MONSTER = 7, QUEST_EXEC_SET_IS_FLYABLE = 8, QUEST_EXEC_SET_IS_WEATHER_LOCKED = 9, QUEST_EXEC_SET_IS_GAME_TIME_LOCKED = 10, QUEST_EXEC_SET_IS_TRANSFERABLE = 11, QUEST_EXEC_GRANT_TRIAL_AVATAR = 12, QUEST_EXEC_OPEN_BORED = 13, QUEST_EXEC_ROLLBACK_QUEST = 14, QUEST_EXEC_NOTIFY_GROUP_LUA = 15, QUEST_EXEC_SET_OPEN_STATE = 16, QUEST_EXEC_LOCK_POINT = 17, QUEST_EXEC_DEL_PACK_ITEM_BATCH = 18, QUEST_EXEC_REFRESH_GROUP_SUITE = 19, QUEST_EXEC_REMOVE_TRIAL_AVATAR = 20, QUEST_EXEC_SET_GAME_TIME = 21, QUEST_EXEC_SET_WEATHER_GADGET = 22, QUEST_EXEC_ADD_QUEST_PROGRESS = 23, QUEST_EXEC_NOTIFY_DAILY_TASK = 24, QUEST_EXEC_CREATE_PATTERN_GROUP = 25, QUEST_EXEC_REMOVE_PATTERN_GROUP = 26, QUEST_EXEC_REFRESH_GROUP_SUITE_RANDOM = 27, QUEST_EXEC_ACTIVE_ITEM_GIVING = 28, QUEST_EXEC_DEL_ALL_SPECIFIC_PACK_ITEM = 29, QUEST_EXEC_ROLLBACK_PARENT_QUEST = 30, QUEST_EXEC_LOCK_AVATAR_TEAM = 31, QUEST_EXEC_UNLOCK_AVATAR_TEAM = 32, QUEST_EXEC_UPDATE_QUEST_VAR = 33, QUEST_EXEC_UPDATE_PARENT_QUEST_REWARD_INDEX = 34}
upval_0.TalkBeginWay, l_0_0 = l_0_0, {TALK_BEGIN_NONE = 0, TALK_BEGIN_AUTO = 1, TALK_BEGIN_MANUAL = 2}
upval_0.TalkHeroType, l_0_0 = l_0_0, {TALK_HERO_LOCAL = 0, TALK_HERO_MAIN = 1}
upval_0.TalkRoleType, l_0_0 = l_0_0, {TALK_ROLE_NONE = 0, TALK_ROLE_NPC = 1, TALK_ROLE_PLAYER = 2}
upval_0.TalkShowType, l_0_0 = l_0_0, {TALK_SHOW_DEFAULT = 0, TALK_SHOW_FORCE_SELECT = 1}
upval_0.RandomQuestFilterType, l_0_0 = l_0_0, {RQ_FILTER_NONE = 0, RQ_FILTER_PLAYER_POS_RING = 1, RQ_FILTER_NPC = 2, RQ_FILTER_PLAYER_LEVEL = 3}
