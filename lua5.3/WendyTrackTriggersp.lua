...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\WendyTrackTriggersp.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("WendyTrackTriggersp", l_0_0)
l_0_1.defaultAlias = "WendyTrackTriggersp"
local l_0_2 = 0
local l_0_3 = 0
