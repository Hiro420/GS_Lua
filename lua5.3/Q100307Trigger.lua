...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q100307Trigger.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q100307Trigger", l_0_0)
l_0_1.defaultAlias = "Q100307Trigger"
...
l_0_1.TriggerIn = function(l_3_0)
  ...
  (upval_0.print)("IN Q100307Trigger")
  local l_3_1 = (upval_0.actorMgr):GetActor(upval_1.ActorAlias)
  if l_3_1 ~= nil then
    l_3_1:FinishQuestID(false, 100307)
  end
  l_3_0:DestroySelf()
end
