...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q7051203_TriggerIn.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q7051203_TriggerIn", l_0_0)
l_0_1.defaultAlias = "Q7051203_TriggerIn"
local l_0_2 = (upval_0.require)("Quest/Client/Q70512ClientConfig")
...
l_0_1.TriggerIn = function(l_3_0)
  ...
  local l_3_1 = (upval_0.actorMgr):GetActor("70512")
  local l_3_5 = l_3_1:EnterSceneLookCamera
  l_3_5(l_3_1, ((upval_0.sceneData):GetDummyPoint(3, "Q7051203_guide")).pos, 0, 3, false, false)
  local l_3_2, l_3_3 = l_3_1
  l_3_3 = upval_1.NarratorWithId_7051202
  local l_3_4 = nil
  l_3_4 = nil
  l_3_5(l_3_2, l_3_3, l_3_4, 70512)
