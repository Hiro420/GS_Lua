...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q4005708Trigger.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q4005708Trigger", l_0_0)
l_0_1.defaultAlias = "Q4005708Trigger"
...
l_0_1.TriggerIn = function(l_3_0)
  ...
  local l_3_1 = (upval_0.actorMgr):GetActor((upval_1.Npc1013Data).alias)
  l_3_1:ShowSelf()
  local l_3_2 = (upval_0.actorMgr):GetActor("40057")
  l_3_2:RequestInteraction((upval_1.Npc1013Data).alias)
  l_3_0:DestroySelf()
end
