...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q19006Trigger190060101.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q19006Trigger190060101", l_0_0)
l_0_1.defaultAlias = "Q19006Trigger190060101"
local l_0_2 = (upval_0.require)("Quest/Client/Q19006ClientConfig")
...
l_0_1.TriggerIn = function(l_3_0)
  ...
  l_3_1:FinishQuestID(false, 1900601)
  l_3_0:DestroySelf()
end
