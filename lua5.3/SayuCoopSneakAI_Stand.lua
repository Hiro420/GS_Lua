...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\SayuCoopSneakAI_Stand.luac 
...
l_0_1.PatrolDir = nil
l_0_1.PatrolNext = 1
local l_0_2 = (upval_0.require)("Quest/Client/Q19014ClientConfig")
local l_0_3 = (upval_0.require)("Quest/Client/Q375ClientConfig")
...
l_0_1.Behave = function(l_3_0)
  ...
  l_3_0:CallDelay(4, l_3_0.StartPatrol)
end
...
l_0_1.Discover = function(l_8_0)
  ...
  l_8_0:Standby()
  l_8_0:DoFreeStateTrigger()
  l_8_0:ClearNarratorTask()
  l_8_0:StopNarrator()
  l_8_0:CallDelay(0.5, function()
    -- function num : 0_7_0 , upvalues : upval_0, upval_1
    upval_0:NarratorOnlyTaskByData(upval_1.NarratorWithId_1901403)
  end
)
  l_8_0:DoFreeStyle(2)
  local l_8_1 = l_8_0:GetPos()
  l_8_0:EnterSceneLookCamera(l_8_1, 0, 2, true, true)
  ;
  (upval_0.globalActor):EnablePlayerInput(false)
  l_8_0:CallDelay(3, function()
    -- function num : 0_7_1 , upvalues : upval_0, ERROR_unknown_upvalue_2
    (upval_0.globalActor):EnablePlayerInput(true)
    local l_10_0 = (upval_0.actorMgr):GetActor(upval_1.ActorAlias)
    if l_10_0 ~= nil then
      (upval_0.print)("Sneak Failed OOOMG")
      l_10_0:FinishQuestID(true, 1901406)
    end
  end
)
end
