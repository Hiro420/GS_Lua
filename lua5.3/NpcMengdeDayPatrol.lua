...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\NpcMengdeDayPatrol.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Npc/DailyNpc")
local l_0_1 = (upval_0.class)("MengdeDayPatrol", l_0_0)
local l_0_2 = (upval_0.require)("Actor/Npc/NPCEventType")
l_0_1.defaultAlias = "MengdeDayPatrol"
l_0_1.pointID = 1
...
l_0_1.StartNight = function(l_10_0)
  -- function num : 0_9
  l_10_0:Standby()
  l_10_0:ClearNpcSpeechBubble(l_10_0.ID)
  l_10_0:PerformDither(false, 2, l_10_0.HideSelf)
end
