...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q4005107Trigger.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q4005107Trigger", l_0_0)
l_0_1.defaultAlias = "Q4005107Trigger"
...
l_0_1.FuncBegin = function(l_1_0)
  ...
  if l_1_3 ~= 11 and l_1_3 ~= 110 and l_1_3 ~= 10 and l_1_3 ~= 111 then
    l_1_3 = l_1_3 + 10
    l_1_1:SetQuestVarByMainId(2, l_1_3)
    ;
    (upval_0.print)("Q4005107 set questvar2 =", l_1_3)
    l_1_2 = l_1_2 + 1
    local l_1_7 = l_1_1:SetQuestVarByMainId
    l_1_7(l_1_1, 1, l_1_2)
    l_1_7 = upval_0.print
    l_1_7("Q4005107 set questvar1 =", l_1_2)
    if l_1_2 == 1 then
