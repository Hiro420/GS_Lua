...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q79007Trigger1.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q79007Trigger1", l_0_0)
l_0_1.defaultAlias = "Q79007Trigger1"
local l_0_2 = (upval_0.require)("Quest/Client/Q79007ClientConfig")
...
l_0_1.TriggerIn = function(l_3_0)
  ...
  if l_3_1:GetSubQuestState(7900701) == 2 then
    l_3_1:FinishQuestID(false, 7900701)
  end
  l_3_0:DestroySelf()
end
