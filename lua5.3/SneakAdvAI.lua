...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\SneakAdvAI.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Npc/NpcActorProxy")
local l_0_1 = (upval_0.class)("SneakAdvAI", l_0_0)
l_0_1.defaultAlias = "SneakAdvAI"
l_0_1.PatrolPosNum = 0
l_0_1.PatrolPos = nil
l_0_1.PatrolDir = nil
l_0_1.PatrolNext = 1
local l_0_2 = (upval_0.require)("Quest/Client/Q424ClientConfig")
...
l_0_1.Aware = function(l_5_0)
  ...
  l_5_0:Standby()
  l_5_0:NarratorOnlyTask(upval_0.AwareReminder)
  local l_5_1 = ((upval_1.actorUtils).GetAvatarPos)()
  local l_5_2 = l_5_0:GetPos()
  local l_5_3 = {}
  l_5_3.x = l_5_1.x - l_5_2.x
  l_5_3.y = l_5_1.y - l_5_2.y
  l_5_3.z = l_5_1.z - l_5_2.z
  l_5_0:TurnTo(l_5_3)
  l_5_0:DoFreeStyle(1)
end
...
l_0_1.Discover = function(l_8_0)
  ...
  l_8_0:Standby()
  l_8_0:DoFreeStateTrigger()
  l_8_0:NarratorOnlyTask(upval_1.DiscoverReminder)
  l_8_0:DoFreeStyle(2)
  local l_8_1 = (upval_0.actorMgr):GetActor(upval_1.ActorAlias)
  if l_8_1 ~= nil then
    (upval_0.print)("Sneak Failed")
    l_8_1:FinishQuestID(true, 42403)
  end
  local l_8_2 = l_8_0:GetPos()
  l_8_0:EnterSceneLookCamera(l_8_2, 0, 2, true)
end

l_0_1.Stun = function(l_9_0)
  -- function num : 0_8 , upvalues : upval_0
  (upval_0.print)("********************Stun")
  l_9_0:DoFreeStyle(5)
  l_9_0:EnableAI(false)
  l_9_0:EnableInteraction(false)
  l_9_0:CallDelay(30, function(l_10_0, l_10_1)
    -- function num : 0_8_0
    l_10_0:EnableAI(true)
...
l_0_1.Start = function(l_10_0)
  -- function num : 0_9
  l_10_0:ThreatTask(l_10_0.Discover, l_10_0.Aware, l_10_0.ReturnToPatrol, l_10_0.OnLure)
  l_10_0:StartPatrol()
end
