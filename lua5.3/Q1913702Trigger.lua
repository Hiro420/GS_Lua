...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q1913702Trigger.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q1913702Trigger", l_0_0)
l_0_1.defaultAlias = "Q1913702Trigger"
local l_0_2 = (upval_0.require)("Quest/Client/Q19137ClientConfig")
...
l_0_1.TriggerIn = function(l_3_0)
  ...
  local l_3_1 = (upval_0.actorMgr):GetActor("19137")
  ...
  local l_3_7 = function(l_4_0)
    ...
    local l_4_1 = (upval_0.actorMgr):GetActor("19137")
    l_4_1:CreateQuestNpcById(1913702, (upval_1.Coop_NingguangData).id, 1)
