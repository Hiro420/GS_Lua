...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q73067Trigger01.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q73067Trigger01", l_0_0)
l_0_1.defaultAlias = "Q73067Trigger01"
local l_0_2 = (upval_0.require)("Quest/Client/Q73067ClientConfig")
...
l_0_1.TriggerIn = function(l_3_0)
  ...
  ;
  ((upval_0.actorUtils).FinishQuestID)(false, 7306701)
  local l_3_1 = (upval_0.actorMgr):GetActor("73067")
  local l_3_2, l_3_3 = l_3_1:NarratorOnlyTask, l_3_1
  local l_3_4 = upval_1.NarratorTable01
  l_3_2(l_3_3, l_3_4, nil, "")
  l_3_2, l_3_3 = l_3_1:EnterSceneLookCamera, l_3_1
  l_3_2(l_3_3, l_3_4, 0, 3, true, false)
  l_3_4 = {x = 119, y = 254, z = 2479}
