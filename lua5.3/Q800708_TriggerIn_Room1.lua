...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q800708_TriggerIn_Room1.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q800708_TriggerIn_Room1", l_0_0)
l_0_1.defaultAlias = "Q800708_TriggerIn_Room1"
...
l_0_1.TriggerIn = function(l_3_0)
  ...
  ;
  (upval_0.print)("In Room 1")
  local l_3_1 = (upval_0.actorMgr):GetActor("8007")
  l_3_1:SetQuestVar(800708, 0, 1)
end
