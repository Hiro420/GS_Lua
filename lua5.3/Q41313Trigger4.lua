...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q41313Trigger4.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q41313Trigger4", l_0_0)
l_0_1.defaultAlias = "Q41313Trigger4"
local l_0_2 = (upval_0.require)("Quest/Client/Q41313ClientConfig")
...
l_0_1.TriggerIn = function(l_3_0)
  ...
  (upval_0.print)("Q41313Trigger4:TriggerIn")
  local l_3_1 = (upval_0.require)("Quest/Client/Q41313ClientConfig")
  local l_3_2 = (upval_0.actorMgr):GetActor(l_3_1.ActorAlias)
  if l_3_2 ~= nil then
    l_3_2:FinishQuestID(false, 4131309)
  end
  l_3_0:DestroySelf()
end
