...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q800602_TriggerIn.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q800602_TriggerIn", l_0_0)
l_0_1.defaultAlias = "Q800602_TriggerIn"
...
l_0_1.TriggerIn = function(l_3_0)
  ...
  l_3_1:NarratorOnlyTaskByData(upval_1.NarratorWithId_800601)
  ;
  ((upval_0.actorUtils).FinishQuestID)(false, 800602)
  l_3_0:DestroySelf()
end
