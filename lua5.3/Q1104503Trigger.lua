...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q1104503Trigger.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q1104503Trigger", l_0_0)
l_0_1.defaultAlias = "Q1104503Trigger"
...
l_0_1.TriggerIn = function(l_3_0)
  ...
  if l_3_1 ~= nil then
    ...
    local l_3_4 = upval_2.NarratorPuzzle2
    l_3_2(l_3_3, l_3_4, nil, 11021)
  end
  do
    ;
    (upval_0.print)("11045 narrator2")
    l_3_0:DestroySelf()
  end
end
