...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q12005TriggerRest.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q12005TriggerRest", l_0_0)
l_0_1.defaultAlias = "Q12005TriggerRest"
...
l_0_1.TriggerIn = function(l_3_0)
  ...
  if l_3_1:GetSubQuestState(1200515) == 2 then
    l_3_1:FinishQuestID(false, 1200515)
  end
  l_3_0:DestroySelf()
end
