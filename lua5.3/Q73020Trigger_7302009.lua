...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q73020Trigger_7302009.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q73020Trigger_7302009", l_0_0)
l_0_1.defaultAlias = "Q73020Trigger_7302009"
local l_0_2 = (upval_0.require)("Quest/Client/Q73020ClientConfig")
...
l_0_1.TriggerIn = function(l_3_0)
  ...
  ;
  ((upval_0.actorUtils).FinishQuestID)(false, 7302009)
  local l_3_1 = (upval_0.actorMgr):GetActor("73020")
  local l_3_2, l_3_3 = l_3_1:NarratorOnlyTask, l_3_1
  local l_3_4 = upval_1.Reminder_7302009
