...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q4141105Trigger.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q4141105Trigger", l_0_0)
l_0_1.defaultAlias = "Q4141105Trigger"
local l_0_2 = (upval_0.require)("Quest/Client/Q41411ClientConfig")
...
l_0_1.TriggerIn = function(l_3_0)
  ...
  if l_3_1 ~= nil then
    (upval_0.print)("q41411Cfg")
    l_3_1:RequestInteractionForceAlias("Npc1457")
  end
  l_3_0:DestroySelf()
end
