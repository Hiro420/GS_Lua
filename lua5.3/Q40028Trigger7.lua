...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q40028Trigger7.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q40028Trigger7", l_0_0)
l_0_1.defaultAlias = "Q40028Trigger7"
...
l_0_1.TriggerIn = function(l_3_0)
  ...
  local l_3_1 = (upval_0.actorMgr):GetActor("40028")
  l_3_1:ActionSafeCall(function(l_4_0)
    ...
    local l_4_4 = "400281001"
    local l_4_5 = function(l_5_0)
      -- function num : 0_2_0_0 , upvalues : upval_0
      local l_5_1 = (upval_0.actorMgr):GetActor("40028")
      l_5_1:FinishQuestID(false, 4002810)
    end

    l_4_2(l_4_3, l_4_4, l_4_5, nil, nil, false)
  end
)
  l_3_0:DestroySelf()
end
