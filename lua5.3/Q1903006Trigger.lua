...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q1903006Trigger.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q1903006Trigger", l_0_0)
l_0_1.defaultAlias = "Q1903006Trigger"
...
l_0_1.TriggerIn = function(l_3_0)
  ...
  l_3_0:CallDelay(1, function(l_4_0)
    ...
    local l_4_6 = function(l_5_0)
      ...
      upval_0:CreateQuestNpcById(1903006, (upval_1.Npc1023Data).id, 0)
      upval_0:RequestInteraction("Npc1023")
      ;
      (upval_2.actorMgr):DestroyEntityActor((upval_3.Q1903006Trigger_).alias, 3, false)
      ;
