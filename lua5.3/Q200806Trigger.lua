...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q200806Trigger.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q200806Trigger", l_0_0)
l_0_1.defaultAlias = "Q200806Trigger"
local l_0_2 = (upval_0.require)("Quest/Client/Q2008ClientConfig")
...
l_0_1.TriggerIn = function(l_3_0)
  ...
  l_3_1:CreateQuestNpcById(200806, (upval_2.Npc1013Data).id, 0)
  l_3_1:RequestInteraction((upval_2.Npc1013Data).alias)
  l_3_0:DestroySelf()
end
