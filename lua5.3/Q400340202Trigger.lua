...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q400340202Trigger.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q400340202Trigger", l_0_0)
l_0_1.defaultAlias = "Q400340202Trigger"
local l_0_2 = (upval_0.require)("Quest/Client/Q40034ClientConfig")
...
l_0_1.TriggerIn = function(l_3_0)
  ...
  local l_3_1 = (upval_0.actorMgr):GetActor("40034")
  local l_3_2, l_3_3 = l_3_1:NarratorOnlyTask, l_3_1
  local l_3_4 = upval_1.NarratorTable400340202
  l_3_2(l_3_3, l_3_4, nil, "")
  l_3_2, l_3_3 = l_3_1:EnterSceneLookCamera, l_3_1
  l_3_4 = upval_0.sceneData
  l_3_4 = l_3_4(l_3_4, 3, "Q40034Longer01")
  l_3_4 = l_3_4.pos
  l_3_2(l_3_3, l_3_4, 0, 3, true, false)
