...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q19065TriggerOut2.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q19065TriggerOut2", l_0_0)
l_0_1.defaultAlias = "Q19065TriggerOut2"
...
l_0_1.TriggerOut = function(l_4_0)
  ...
  (upval_0.print)("Out Q19065trigger02")
  local l_4_1 = (upval_0.actorMgr):GetActor(upval_1.ActorAlias)
  if l_4_1:GetSubQuestState(1906507) == 2 then
    l_4_1:FinishQuestID(true, 1906507)
    l_4_1:ClearNarratorTask()
    ;
    (upval_0.print)("let 1906507 fail")
  end
  if l_4_1:GetSubQuestState(1906508) == 2 then
    l_4_1:FinishQuestID(true, 1906508)
    l_4_1:ClearNarratorTask()
    ;
    (upval_0.print)("let 1906508 fail")
  end
  l_4_0:DestroySelf()
end
