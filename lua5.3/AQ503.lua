...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\AQ503.luac 
...
l_0_3 = l_0_3("Quest503", l_0_0)
local l_0_1 = nil
l_0_3.defaultAlias = "Quest503"
local l_0_2 = nil
local l_0_5 = nil
local l_0_6 = 0
local l_0_7 = nil
local l_0_8 = ((upval_0.require)("Actor/Quest/Q503/Q503Config")).SubIDs
...
local l_0_19 = function()
  ...
  (upval_0.print)("50301 start: Clue7 Create")
  ;
  (upval_0.globalActor):SpawnItem(upval_1.Clue1ID, upval_1.CluePos1, 0, "q503Clue1")
end

local l_0_20 = function()
  -- function num : 0_4 , upvalues : upval_0, ERROR_unknown_upvalue_6
  (upval_0.print)("50302 start: Clue8 Create")
  ;
  (upval_0.globalActor):SpawnItem(upval_1.Clue2ID, upval_1.CluePos2, 0, "q503Clue2")
end

local l_0_21 = function()
  -- function num : 0_5 , upvalues : upval_0, ERROR_unknown_upvalue_6
  (upval_0.print)("50303 start: Clue9 Create")
  ;
  (upval_0.globalActor):SpawnItem(upval_1.Clue3ID, upval_1.CluePos3, 0, "q503Clue3")
end

local l_0_22 = function()
  -- function num : 0_6 , upvalues : upval_0
  (upval_0.print)("50304 start:......")
end
...
local l_0_23 = function()
  ...
  local l_8_4 = nil
  ;
  (upval_0.print)("50305 start: Finish Quest")
  local l_8_0 = (upval_0.actorMgr):GetActor(upval_1.ActorAlias)
  if l_8_0 ~= nil then
...
local l_0_24 = function()
  ...
  (upval_0.print)("50306 Start: Finish Quest & Play CutScene2")
  upval_1:PlayCutscene((upval_0.q5032Cfg).SealOpenTimeCfg, function(l_10_0)
...
local l_0_25 = function()
  ...
  (upval_0.print)("50301 finish: Clue1 UnSpawn")
  ;
  (upval_0.globalActor):UnSpawn("q503Clue1")
end

local l_0_26 = function()
  -- function num : 0_10 , upvalues : upval_0
  (upval_0.print)("50302 finish: Clue2 UnSpawn")
  ;
  (upval_0.globalActor):UnSpawn("q503Clue2")
end

local l_0_27 = function()
  -- function num : 0_11 , upvalues : upval_0
  (upval_0.print)("50303 finish: Clue3 UnSpawn")
  ;
  (upval_0.globalActor):UnSpawn("q503Clue3")
end

local l_0_28 = function()
  -- function num : 0_12 , upvalues : upval_0
  (upval_0.print)("50304 finish: Play Cutscene 2")
end

local l_0_29 = function()
  -- function num : 0_13 , upvalues : upval_0, upval_2, ERROR_unknown_upvalue_6
  local l_14_4 = nil
  ;
  (upval_0.print)("50305 Start: Finish Quest & Play CutScene 1")
  upval_1:PlayCutscene(upval_2.SealAppearTimeCfg)
  local l_14_0 = (upval_0.actorMgr):GetActor(upval_2.ActorAlias)
  if l_14_0 ~= nil then
    local l_14_1, l_14_2 = l_14_0:FinishQuest, l_14_0
    local l_14_3 = false
    l_14_1(l_14_2, l_14_3, nil)
  end
end

local l_0_30 = function()
  -- function num : 0_14 , upvalues : upval_0
  (upval_0.print)("50306 finish:......")
end
...
local l_0_31 = function()
  ...
  (upval_0.print)("50304 rewind: Creat NPC")
  ;
...
local l_0_32 = function()
  ...
  (upval_0.print)("50305 rewind: Creat NPC")
  ;
  (upval_0.actorMgr):CreateActorWithPos(upval_1.Wendy, upval_1.WendyScript, upval_1.WendyID, 0, upval_1.bornPos, upval_1.bornDir, true)
  ;
  (upval_0.actorMgr):CreateActorWithPos(upval_2.Diluc, upval_2.DilucScript, upval_2.DilucID, 0, upval_2.bornPos, upval_2.bornDir, true)
