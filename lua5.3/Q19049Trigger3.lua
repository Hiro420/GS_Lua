...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q19049Trigger3.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q19049Trigger3", l_0_0)
l_0_1.defaultAlias = "Q19049Trigger3"
local l_0_2 = (upval_0.require)("Quest/Client/Q19049ClientConfig")
...
l_0_1.TriggerIn = function(l_3_0)
  ...
  local l_3_1 = (upval_0.actorMgr):GetActor("19049")
  ...
  local l_3_7 = function(l_4_0)
    ...
    local l_4_1 = (upval_0.actorMgr):GetActor("19049")
    l_4_1:CreateQuestNpcById(1904910, (upval_1.Coop_GorouData).id, 0)
    l_4_1:RequestCoopInteractionFromSubStartPoint(105901, 1904910)
