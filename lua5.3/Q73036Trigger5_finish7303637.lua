...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q73036Trigger5_finish7303637.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q73036Trigger5_finish7303637", l_0_0)
l_0_1.defaultAlias = "Q73036Trigger5_finish7303637"
...
l_0_1.TriggerIn = function(l_3_0)
  ...
  ;
  ((upval_0.actorUtils).FinishQuestID)(false, 7303637)
  ...
  l_3_1:CallDelay(2, function(l_4_0)
    ...
    local l_4_4 = upval_1.NarratorTable_Arama18
