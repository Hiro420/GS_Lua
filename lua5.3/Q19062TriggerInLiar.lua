...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q19062TriggerInLiar.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q19062TriggerInLiar", l_0_0)
l_0_1.defaultAlias = "Q19062TriggerInLiar"
local l_0_2 = (upval_0.require)("Quest/Client/Q19062ClientConfig")
...
l_0_1.TriggerIn = function(l_3_0)
  ...
  if l_3_1:GetSubQuestState(1906211) == 2 then
    l_3_1:FinishQuestID(false, 1906211)
  end
  l_3_0:DestroySelf()
end
