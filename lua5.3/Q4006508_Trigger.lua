...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q4006508_Trigger.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q4006508_Trigger", l_0_0)
l_0_1.defaultAlias = "Q4006508_Trigger"
...
l_0_1.OnPostComponentPrepare = function(l_2_0)
  ...
  local l_2_3 = 29.69056
  local l_2_4 = 28.85332
  local l_2_5 = 21.12899
  local l_2_6 = false
  local l_2_7 = {}
  l_2_7.x = 0
  l_2_7.y = 0
...
l_0_1.TriggerIn = function(l_3_0)
  ...
  l_3_1:CreateQuestNpcById(4006508, (upval_1.Npc1042Data).id, 1)
