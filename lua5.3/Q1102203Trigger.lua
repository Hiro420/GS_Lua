...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q1102203Trigger.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q1102203Trigger", l_0_0)
l_0_1.defaultAlias = "Q1102203Trigger"
...
l_0_1.TriggerIn = function(l_3_0)
  -- function num : 0_2 , upvalues : upval_0, upval_2, ERROR_unknown_upvalue_12
  local l_3_5 = nil
  local l_3_1 = (upval_0.actorMgr):GetActor(upval_1.ActorAlias)
  if l_3_1 ~= nil then
    local l_3_2, l_3_3 = l_3_1:NarratorOnlyTaskByData, l_3_1
    local l_3_4 = upval_2
    l_3_2(l_3_3, l_3_4, nil, 11022)
  end
  do
    ;
    (upval_0.print)("11022 narrator 01")
    local l_3_6 = (upval_0.actorMgr):GetActor(upval_1.ActorAlias)
    if l_3_6 ~= nil then
      l_3_6:FinishQuestID(false, 1102208)
    end
    l_3_0:DestroySelf()
  end
end
