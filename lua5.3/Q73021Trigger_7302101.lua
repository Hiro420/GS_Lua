...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q73021Trigger_7302101.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q73021Trigger_7302101", l_0_0)
l_0_1.defaultAlias = "Q73021Trigger_7302101"
local l_0_2 = (upval_0.require)("Quest/Client/Q73021ClientConfig")
...
l_0_1.TriggerIn = function(l_3_0)
  ...
  local l_3_1 = (upval_0.actorMgr):GetActor("73021")
  local l_3_5 = l_3_1:EnterSceneLookCamera
  l_3_5(l_3_1, ((upval_0.sceneData):GetDummyPoint(3, "Q7302102_guide")).pos, 0, 3, true, false)
  l_3_5 = upval_0.actorUtils
  l_3_5 = l_3_5.FinishQuestID
  l_3_5(false, 7302101)
  local l_3_2, l_3_3 = l_3_1
  l_3_3 = upval_1.Reminder_7302101
  local l_3_4 = nil
  l_3_4 = nil
