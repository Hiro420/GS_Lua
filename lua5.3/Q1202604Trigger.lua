...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q1202604Trigger.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q1202604Trigger", l_0_0)
l_0_1.defaultAlias = "Q1202604Trigger"
...
l_0_1.TriggerIn = function(l_3_0)
  ...
  local l_3_2, l_3_3 = l_3_1:TransmitPlayerByQuestId, l_3_1
  local l_3_4 = 1202603
  local l_3_5 = 1202603
  l_3_2(l_3_3, l_3_4, l_3_5, nil, function(l_4_0)
    -- function num : 0_2_0 , upvalues : upval_0, upval_1
    local l_4_1 = (upval_0.actorMgr):GetActor("12026")
    l_4_1:CreateQuestNpcById(1202603, (upval_1.Npc1044Data).id, 0)
    l_4_1:RequestInteraction((upval_1.Npc1044Data).alias)
  end
)
end
