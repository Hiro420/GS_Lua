...
-- Command line: C:\Users\nikur\Documents\3.3.51_lua\MiHoYoBinData\RQ30031.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Quest/QuestActorProxy")
local l_0_1 = (upval_0.class)("Quest30031", l_0_0)
l_0_1.defaultAlias = "Quest30031"
local l_0_2 = (upval_0.require)("Quest/Client/Q30031ClientConfig")
...
l_0_1.OnSubStartHandlerBuild = function(l_1_0)
  ...
  ;
  (l_1_0.subStartHandlers)["3003101"] = l_1_0.OnSubStart3003101
  -- DECOMPILER ERROR at PC7: Confused about usage of register: R1 in 'UnsetPending'

  ;
  (l_1_0.subStartHandlers)["3003102"] = l_1_0.OnSubStart3003102
  -- DECOMPILER ERROR at PC10: Confused about usage of register: R1 in 'UnsetPending'

  ;
  (l_1_0.subStartHandlers)["3003103"] = l_1_0.OnSubStart3003103
end
...
l_0_1.OnSubFinishHandlerBuild = function(l_2_0)
  ...
  ;
  (l_2_0.subFinishHandlers)["3003101"] = l_2_0.OnSubFinish3003101
  -- DECOMPILER ERROR at PC7: Confused about usage of register: R1 in 'UnsetPending'

  ;
  (l_2_0.subFinishHandlers)["3003102"] = l_2_0.OnSubFinish3003102
  -- DECOMPILER ERROR at PC10: Confused about usage of register: R1 in 'UnsetPending'

  ;
  (l_2_0.subFinishHandlers)["3003103"] = l_2_0.OnSubFinish3003103
end
...
l_0_1.OnSubFailedHandlerBuild = function(l_3_0)
  ...
  ;
  (l_3_0.subFailedHandlers)["3003101"] = l_3_0.OnSubFailed3003101
  -- DECOMPILER ERROR at PC7: Confused about usage of register: R1 in 'UnsetPending'

  ;
  (l_3_0.subFailedHandlers)["3003102"] = l_3_0.OnSubFailed3003102
  -- DECOMPILER ERROR at PC10: Confused about usage of register: R1 in 'UnsetPending'

  ;
  (l_3_0.subFailedHandlers)["3003103"] = l_3_0.OnSubFailed3003103
end
...
l_0_1.OnSubStart3003101 = function(l_5_0, l_5_1)
  -- function num : 0_4 , upvalues : upval_0
  (upval_0.print)("OnSubStart3003101")
  l_5_0:CreateQuestNpc(l_5_1, 0, 1)
  l_5_0:CallDelay(60, l_5_0.QuestDestroy)
end

l_0_1.OnSubFinish3003101 = function(l_6_0, l_6_1)
  -- function num : 0_5
  l_6_0:UnCallFunc(l_6_0.QuestDestroy)
end

l_0_1.OnSubStart3003102 = function(l_7_0, l_7_1)
  -- function num : 0_6 , upvalues : upval_0
  (upval_0.print)("OnSubStart3003102")
...
l_0_1.OnSubFinish3003102 = function(l_8_0, l_8_1)
  -- function num : 0_7 , upvalues : upval_0
  (upval_0.print)("OnSubFinish3003102")
  local l_8_2 = l_8_0:GetQuestNpcActor("{QuestNpcID}")
  l_8_2:DoFreeStateTrigger()
  l_8_2:Standby()
end

l_0_1.OnSubFinish3003103 = function(l_9_0, l_9_1)
  -- function num : 0_8
