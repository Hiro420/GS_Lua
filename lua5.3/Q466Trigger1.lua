...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q466Trigger1.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q466trigger1", l_0_0)
l_0_1.defaultAlias = "Q466trigger1"
...
l_0_1.OnPostComponentPrepare = function(l_2_0)
  ...
  l_2_0:AddComponentTrigger(95, (upval_0.DistType).EULER, ((upval_0.M).Pos)(0, 0.8, 0), l_2_0.TriggerIn, l_2_0.TriggerOut)
end
...
l_0_1.TriggerOut = function(l_4_0, l_4_1)
  ...
  local l_4_6 = nil
  ;
  (upval_0.print)("Out Q466trigger1")
  if l_4_1 ~= 1009 then
