...
-- Command line: C:\Users\nikur\Documents\2.8.50_dev_lua\MiHoYoBinData\Q1300107Trigger.luac 

-- params : ...
-- function num : 0 , upvalues : upval_0
(upval_0.require)("Actor/ActorCommon")
local l_0_0 = (upval_0.require)("Actor/Gadget/GadgetActorProxy")
local l_0_1 = (upval_0.class)("Q1300107Trigger", l_0_0)
l_0_1.defaultAlias = "Q1300107Trigger"
...
l_0_1.TriggerIn = function(l_3_0)
  ...
  l_3_1:CreateQuestNpcById(1300107, (upval_1.Npc12603Data).id, 2)
  l_3_1:RequestInteraction((upval_1.Npc12603Data).alias)
end
